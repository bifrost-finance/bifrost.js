...
import type { Token } from '@bifrost-finance/types/interfaces/assets';
...
import type { AccountId, AccountIndex, AssetId, Balance, BlockNumber, CallHash, Hash, Permill, PhantomData } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/events' {
  export interface AugmentedEvents<ApiType> {
    assets: {
       ...
       **/
      AccountAssetCreated: AugmentedEvent<ApiType, [AccountId, AssetId]>;
      /**
       * Bind Asset with AccountId
       **/
      AccountAssetDestroy: AugmentedEvent<ApiType, [AccountId, AssetId]>;
      /**
       * Some assets were created.
       **/
      Created: AugmentedEvent<ApiType, [AssetId, Token]>;
      /**
       ...
       * Unlock user asset
       **/
      UnlockedAsset: AugmentedEvent<ApiType, [AccountId, AssetId, TAssetBalance]>;
    };
    balances: {
      /**
    ...
    bid: {
      CreateOrderSuccess: AugmentedEvent<ApiType, [AssetId, BiddingOrderId]>;
      CreateProposalSuccess: AugmentedEvent<ApiType, []>;
      DeleteOrderSuccess: AugmentedEvent<ApiType, [AssetId, BiddingOrderId]>;
      SetBlockNumberPerEraSuccess: AugmentedEvent<ApiType, [AssetId, BlockNumber]>;
      SetMinMaxOrderLastingBlockNumSuccess: AugmentedEvent<ApiType, [AssetId, BlockNumber, BlockNumber]>;
      SetOrderEndTimeSuccess: AugmentedEvent<ApiType, [BiddingOrderId, BlockNumber]>;
      SetServiceStopBlockNumLagSuccess: AugmentedEvent<ApiType, [AssetId, BlockNumber]>;
      SetSlashMarginRatesSuccess: AugmentedEvent<ApiType, [AssetId, Permill]>;
      VtokenRegisterSuccess: AugmentedEvent<ApiType, [AssetId]>;
    };
    bounties: {
      /**
    ...
    swap: {
      AddLiquiditySuccess: AugmentedEvent<ApiType, []>;
      AddSingleLiquiditySuccess: AugmentedEvent<ApiType, []>;
      CreatePoolSuccess: AugmentedEvent<ApiType, []>;
      RemoveLiquiditySuccess: AugmentedEvent<ApiType, []>;
      RemoveSingleLiquiditySuccess: AugmentedEvent<ApiType, []>;
      SetPoolStatusSuccess: AugmentedEvent<ApiType, []>;
      SetSwapFeeSuccess: AugmentedEvent<ApiType, []>;
      SwapTokenSuccess: AugmentedEvent<ApiType, [Balance, Balance]>;
    };
    system: {
      /**
       * `:code` was updated.
    ...
    vtokenMint: {
      MintTokenSuccess: AugmentedEvent<ApiType, []>;
      MintVTokenSuccess: AugmentedEvent<ApiType, []>;
