...
import type { Bytes, HashMap, Json, Null, Option, Text, U256, U32, U64, Vec, bool, u128, u32, u64 } from '@polkadot/types-codec';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  export interface RpcInterface {
    ...
    oracle: {
       ...
       **/
      getValue: AugmentedRpc<(providerId: RpcDataProviderId | string, key: OracleKey | { Native: any } | { VToken: any } | { Token: any } | { Stable: any } | { VSToken: any } | { VSBond: any } | { LPToken: any } | { Token2: any } | { VToken2: any } | { VSToken2: any } | { VSBond2: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Option<TimestampedValue>>>;
    };
    payment: {
      /**
    ...
    vtokenMint: {
       ...
       **/
      getVtokenMintRate: AugmentedRpc<(asset_id: CurrencyId | { Native: any } | { VToken: any } | { Token: any } | { Stable: any } | { VSToken: any } | { VSBond: any } | { LPToken: any } | { Token2: any } | { VToken2: any } | { VSToken2: any } | { VSBond2: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Text>>;
    };
    web3: {
      /**
