...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    TrxStatus: TrxStatus;
    'Option<TrxStatus>': Option<TrxStatus>;
    'Vec<TrxStatus>': Vec<TrxStatus>;
    Cost: Cost;
