...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    assets: {
       ...
       **/
      totalIssuance: AugmentedQuery<ApiType, (arg: CurrencyId | { Token: any } | { VToken: any } | { Native: any } | { Stable: any } | { VSToken: any } | { VSBond: any } | string | Uint8Array) => Observable<TAssetBalance>, [CurrencyId]>;
    };
    balances: {
      /**
    ...
    salp: {
      ...
      validators: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<bool>, [AccountId]>;
    };
    scheduler: {
      /**
    ...
    zenlinkProtocol: {
       ...
       **/
      foreignLedger: AugmentedQuery<ApiType, (arg: ITuple<[AssetId, AccountId]> | [AssetId | AnyNumber | Uint8Array, AccountId | string | Uint8Array]) => Observable<AssetBalance>, [ITuple<[AssetId, AccountId]>]>;
      foreignList: AugmentedQuery<ApiType, () => Observable<Vec<AssetId>>, []>;
      /**
       * TWOX-NOTE: `AssetId` is trusted, so this is safe.
       **/
      foreignMeta: AugmentedQuery<ApiType, (arg: AssetId | AnyNumber | Uint8Array) => Observable<AssetBalance>, [AssetId]>;
      /**
       * ((AssetId, AssetId), AccountId) -> AssetBalance
       **/
      liquidityLedger: AugmentedQuery<ApiType, (arg: ITuple<[ITuple<[AssetId, AssetId]>, AccountId]> | [ITuple<[AssetId, AssetId]> | [AssetId | AnyNumber | Uint8Array, AssetId | AnyNumber | Uint8Array], AccountId | string | Uint8Array]) => Observable<AssetBalance>, [ITuple<[ITuple<[AssetId, AssetId]>, AccountId]>]>;
      /**
       * Swap liquidity storage
       * TWOX-NOTE: `AssetId` is trusted, so this is safe.
       * (AssetId, AssetId) -> (PairAccountId, TotalSupply)
       **/
      liquidityMeta: AugmentedQuery<ApiType, (arg: ITuple<[AssetId, AssetId]> | [AssetId | AnyNumber | Uint8Array, AssetId | AnyNumber | Uint8Array]) => Observable<Option<ITuple<[AccountId, AssetBalance]>>>, [ITuple<[AssetId, AssetId]>]>;
