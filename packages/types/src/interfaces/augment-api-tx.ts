...
import type { Action, ActionReceipt, Checksum256, Checksum256Array, ConvertPrice, IncrementalMerkle, IostAction, ProducerAuthoritySchedule, RatePerBlock, SignedBlockHeader, TokenSymbol, TrxStatus, TxOut, TxOutV1 } from '@bifrost-finance/types/interfaces/primitives';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    assets: {
       ...
       **/
      issue: AugmentedSubmittable<(tokenSymbol: TokenSymbol | 'aUSD' | 'DOT' | 'vDOT' | 'KSM' | 'vKSM' | 'EOS' | 'vEOS' | 'IOST' | 'vIOST' | number | Uint8Array, target: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
       ...
       **/
      transfer: AugmentedSubmittable<(tokenSymbol: TokenSymbol | 'aUSD' | 'DOT' | 'vDOT' | 'KSM' | 'vKSM' | 'EOS' | 'vEOS' | 'IOST' | 'vIOST' | number | Uint8Array, target: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Issue any amount of fungible assets.
       **/
      unlock: AugmentedSubmittable<(tokenSymbol: TokenSymbol | 'aUSD' | 'DOT' | 'vDOT' | 'KSM' | 'vKSM' | 'EOS' | 'vEOS' | 'IOST' | 'vIOST' | number | Uint8Array, target: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    authorship: {
      /**
    ...
    bridgeEos: {
      ...
      updateBridgeTrxStatus: AugmentedSubmittable<(changedTrxs: Vec<ITuple<[ITuple<[TxOutV1, u64]>, TrxStatus, ITuple<[TxOutV1, u64]>, Option<Checksum256>]>> | ([ITuple<[TxOutV1, u64]> | [TxOutV1 | { Initialized: any } | { Created: any } | { CompleteSigned: any } | { Sent: any } | { Succeeded: any } | { Failure: any } | string | Uint8Array, u64 | AnyNumber | Uint8Array], TrxStatus | 'Initial' | 'Generated' | 'Signed' | 'Processing' | 'Success' | 'Fail' | number | Uint8Array, ITuple<[TxOutV1, u64]> | [TxOutV1 | { Initialized: any } | { Created: any } | { CompleteSigned: any } | { Sent: any } | { Succeeded: any } | { Failure: any } | string | Uint8Array, u64 | AnyNumber | Uint8Array], Option<Checksum256> | null | object | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>>;
    };
    bridgeIost: {
      bridgeEnable: AugmentedSubmittable<(enable: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    voucher: {
      destroyVoucher: AugmentedSubmittable<(dest: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      issueVoucher: AugmentedSubmittable<(dest: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
  }
