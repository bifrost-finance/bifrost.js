...
import type { TokenType } from '@bifrost-finance/types/interfaces/assets';
import type { BiddingOrderId } from '@bifrost-finance/types/interfaces/bid';
import type { PoolCreateTokenDetails, PoolId, PoolToken, SwapFee } from '@bifrost-finance/types/interfaces/swap';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    assets: {
       ...
       **/
      create: AugmentedSubmittable<(symbol: Bytes | string | Uint8Array, precision: u16 | AnyNumber | Uint8Array, tokenType: TokenType | 'Native' | 'Stable' | 'Token' | 'VToken' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u16, TokenType]>;
      createPair: AugmentedSubmittable<(symbol: Bytes | string | Uint8Array, precision: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u16]>;
      /**
       * Destroy any amount of assets of `id` owned by `origin`.
       **/
      destroy: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, amount: Compact<TAssetBalance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<TAssetBalance>]>;
      /**
       * Issue any amount of fungible assets.
       **/
      issue: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, target: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, amount: Compact<TAssetBalance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, Compact<TAssetBalance>]>;
      redeem: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, amount: Compact<TAssetBalance> | AnyNumber | Uint8Array, toName: Option<Bytes> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<TAssetBalance>, Option<Bytes>]>;
      /**
       * Move some assets from one holder to another.
       **/
      transfer: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, target: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, amount: Compact<TAssetBalance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, Compact<TAssetBalance>]>;
      /**
       * Issue any amount of fungible assets.
       **/
      unlock: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, target: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, amount: Compact<TAssetBalance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, LookupSource, Compact<TAssetBalance>]>;
    };
    authorship: {
      /**
    ...
    bid: {
       ...
       **/
      cancelABiddingProposal: AugmentedSubmittable<(proposalId: BiddingOrderId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BiddingOrderId]>;
      /**
       * Create a bidding proposal and update it to the corresponding storage
       **/
      createBiddingProposal: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array, votesNeeded: Compact<Balance> | AnyNumber | Uint8Array, roi: u32 | AnyNumber | Uint8Array, validator: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<Balance>, u32, AccountId]>;
      /**
       * Register a vtoken for bidding marketplace
       **/
      registerVtokenForBidding: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId]>;
      /**
       * This function is call by outer pallets.
       **/
      setBiddingOrderEndTime: AugmentedSubmittable<(orderId: BiddingOrderId | AnyNumber | Uint8Array, endBlockNum: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BiddingOrderId, BlockNumber]>;
      /**
       * Set the default block number per era for each vtoken according to its original token chain
       **/
      setBlockNumberPerEra: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array, blockNumPerEra: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, BlockNumber]>;
      /**
       ...
       **/
      setMinMaxOrderLastingBlockNum: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array, minimum: BlockNumber | AnyNumber | Uint8Array, maximum: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, BlockNumber, BlockNumber]>;
      /**
       * set the lag block number before we can change voting for another validator when we stop a taking
       **/
      setServiceStopBlockNumLag: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array, serviceStopLagBlockNum: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, BlockNumber]>;
      /**
       * Set slash margin rate for each vtoken.
       **/
      setSlashMarginRates: AugmentedSubmittable<(vtoken: AssetId | AnyNumber | Uint8Array, slashMargin: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, u32]>;
    };
    bounties: {
      /**
    ...
    swap: {
       ...
       **/
      addLiquidityGivenSharesIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, newPoolToken: Compact<PoolToken> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, Compact<PoolToken>]>;
      /**
       ...
       **/
      addSingleLiquidityGivenAmountIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, assetId: AssetId | AnyNumber | Uint8Array, tokenAmountIn: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<Balance>]>;
      /**
       * A user adds liquidity by depositing only one kind of token.
       * So we need to calculate the corresponding pool token share the user should get.
       * (add liquidity)(single asset) given share in => amount out
       **/
      addSingleLiquidityGivenSharesIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, assetId: AssetId | AnyNumber | Uint8Array, newPoolToken: Compact<PoolToken> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<PoolToken>]>;
      /**
       * User claims bonus from only one pool
       **/
      claimBonus: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId]>;
      /**
       * Above are the exchange functions.
       * Below are the exchange management functions.
       **/
      createPool: AugmentedSubmittable<(swapFeeRate: SwapFee | AnyNumber | Uint8Array, tokenForPoolVec: Vec<PoolCreateTokenDetails> | (PoolCreateTokenDetails | { token_id?: any; token_balance?: any; token_weight?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [SwapFee, Vec<PoolCreateTokenDetails>]>;
      /**
       ...
       **/
      removeAssetsLiquidityGivenSharesIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, poolAmountOut: Compact<PoolToken> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, Compact<PoolToken>]>;
      /**
       * User remove liquidity with only one kind of token
       * (remove liquidity)(single asset) given amount in => shares out
       **/
      removeSingleAssetLiquidityGivenAmountIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, assetId: AssetId | AnyNumber | Uint8Array, tokenAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<Balance>]>;
      /**
       * User remove liquidity with only one kind of token
       * (remove liquidity)(single asset) given share in => amount out
       **/
      removeSingleAssetLiquidityGivenSharesIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, assetId: AssetId | AnyNumber | Uint8Array, poolTokenOut: Compact<PoolToken> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<PoolToken>]>;
      /**
       * set the pool status to be true or false.
       **/
      setPoolStatus: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, newStatus: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, bool]>;
      /**
       * reset the swap fee
       **/
      setSwapFee: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, newSwapFee: SwapFee | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, SwapFee]>;
      /**
       * User swap one token for another kind of token, given an exact amount for token-in.
       **/
      swapExactIn: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, tokenInAssetId: AssetId | AnyNumber | Uint8Array, tokenAmountIn: Compact<Balance> | AnyNumber | Uint8Array, minTokenAmountOut: Option<Balance> | null | object | string | Uint8Array, tokenOutAssetId: AssetId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<Balance>, Option<Balance>, AssetId]>;
      /**
       * User swap one token for another kind of token, given an exact amount for token-out.
       **/
      swapExactOut: AugmentedSubmittable<(poolId: PoolId | AnyNumber | Uint8Array, tokenOutAssetId: AssetId | AnyNumber | Uint8Array, tokenAmountOut: Compact<Balance> | AnyNumber | Uint8Array, maxTokenAmountIn: Option<Balance> | null | object | string | Uint8Array, tokenInAssetId: AssetId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PoolId, AssetId, Compact<Balance>, Option<Balance>, AssetId]>;
    };
    system: {
      /**
    ...
    vtokenMint: {
      setVtokenPool: AugmentedSubmittable<(assetId: AssetId | AnyNumber | Uint8Array, newTokenPool: Compact<Balance> | AnyNumber | Uint8Array, newVtokenPool: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<Balance>, Compact<Balance>]>;
      toToken: AugmentedSubmittable<(tokenAssetId: AssetId | AnyNumber | Uint8Array, vtokenAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<Balance>]>;
      toVtoken: AugmentedSubmittable<(vtokenAssetId: AssetId | AnyNumber | Uint8Array, tokenAmount: Compact<Balance> | AnyNumber | Uint8Array, referer: Option<AccountId> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AssetId, Compact<Balance>, Option<AccountId>]>;
    };
  }
