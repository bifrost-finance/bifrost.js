...
import type { EcdsaSignature, Extrinsic, MultiSignature, Signature } from '@polkadot/types/interfaces/extrinsics';
...
import type { AccountId, AccountIndex, Balance, BalanceOf, BlockNumber, Call, CallHashOf, ChangesTrieConfiguration, Hash, Header, KeyValue, LookupSource, Moment, MultiSigner, OpaqueCall, Perbill, Percent, Perquintill, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    claims: {
       ...
       * </weight>
       **/
      mintClaim: AugmentedSubmittable<(who: EthereumAddress | string | Uint8Array, value: BalanceOf | AnyNumber | Uint8Array, vestingSchedule: Option<ITuple<[BalanceOf, BalanceOf, BlockNumber]>> | null | object | string | Uint8Array, statement: Option<StatementKind> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [EthereumAddress, BalanceOf, Option<ITuple<[BalanceOf, BalanceOf, BlockNumber]>>, Option<StatementKind>]>;
      moveClaim: AugmentedSubmittable<(old: EthereumAddress | string | Uint8Array, updated: EthereumAddress | string | Uint8Array, maybePreclaim: Option<AccountId> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [EthereumAddress, EthereumAddress, Option<AccountId>]>;
    };
    council: {
      /**
    ...
    vesting: {
       ...
       * # </weight>
       **/
      vestedTransfer: AugmentedSubmittable<(target: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, schedule: VestingInfo | { locked?: any; per_block?: any; starting_block?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [LookupSource, VestingInfo]>;
    };
    xcmPallet: {
      /**
