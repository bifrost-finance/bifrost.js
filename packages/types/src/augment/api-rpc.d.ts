...
import type { AccountId, AccountIdOf, Balance, BlockNumber, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, SignedBlock, StorageData } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
    interface RpcInterface {
        ...
        vtokenMint: {
             ...
             **/
            getVtokenMintRate: AugmentedRpc<(asset_id: CurrencyId | {
                Native: any;
            } | {
                VToken: any;
            } | {
                ...
                StableLpToken: any;
            } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Text>>;
        };
        web3: {
            /**
        ...
        zenlinkProtocol: {
             ...
             **/
            getAmountInPrice: AugmentedRpc<(supply: ZenlinkAssetBalance | AnyNumber | Uint8Array, path: Vec<ZenlinkAssetId> | (ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
             ...
             **/
            getAmountOutPrice: AugmentedRpc<(supply: ZenlinkAssetBalance | AnyNumber | Uint8Array, path: Vec<ZenlinkAssetId> | (ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array)[], at?: BlockHash | string | Uint8Array) => Observable<u128>>;
             ...
             **/
            getBalance: AugmentedRpc<(asset_id: ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, account: AccountId | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<Text>>;
            /**
             * Get the estimated number of LP token acquired given the desired and minimum amount for both in-token and out-token.
             **/
            getEstimateLptoken: AugmentedRpc<(asset_0: ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, asset_1: ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, amount_0_desired: ZenlinkAssetBalance | AnyNumber | Uint8Array, amount_1_desired: ZenlinkAssetBalance | AnyNumber | Uint8Array, amount_0_min: ZenlinkAssetBalance | AnyNumber | Uint8Array, amount_1_min: ZenlinkAssetBalance | AnyNumber | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<u128>>;
            /**
             * Get the detailed information of a particular exchange pair.
             **/
            getPairByAssetId: AugmentedRpc<(asset_0: ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, asset_1: ZenlinkAssetId | {
                ...
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<PairInfo>>;
            /**
             * Get the ownership of a certain currency for each parachain.
             **/
            getSovereignsInfo: AugmentedRpc<(asset_id: ZenlinkAssetId | {
                chain_id?: any;
                asset_type?: any;
                asset_index?: any;
            } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<ITuple<[u32, AccountId, Text]>>>;
        };
    }
}
