...
import { AccountAsset, AccountName, ActionName, ActionReceipt, BlockHeader, BlockTimestamp, BlockchainType, BridgeAssetSymbol, Checksum256, Cost, DataVersion, ExchangeRate, Extension, Fee, FlatMap, InVariantPool, Income, IncrementalMerkle, Precision, Price, ProducerKey, ProducerSchedule, PublicKey, RatePerBlock, RequestIdentifier, SignedBlockHeader, SpecIndex, Token, TokenPair, TokenPool, TokenType, TxOut, UnsignedInt, VTokenPool, VersionId } from '@bifrost-network/types/interfaces/primitives';
import { AccountId, AccountIdOf, AccountIndex, Address, AssetId, Balance, BalanceOf, BidId, Block, BlockNumber, Call, ChangesTrieConfiguration, Consensus, ConsensusEngineId, Digest, DigestItem, DispatchClass, DispatchInfo, DispatchInfoTo190, Fixed64, H160, H256, H512, Hash, Header, Index, Justification, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, Moment, Origin, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, PreRuntime, Seal, SealV0, SignedBlock, StorageData, ValidatorId, Weight, WeightMultiplier } from '@bifrost-network/types/interfaces/runtime';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Compact<ExchangeRate>': Compact<ExchangeRate>;
    ...
    TokenPair: TokenPair;
    'Option<TokenPair>': Option<TokenPair>;
    'Vec<TokenPair>': Vec<TokenPair>;
    Cost: Cost;
    ...
    BidId: BidId;
    'Compact<BidId>': Compact<BidId>;
    'Option<BidId>': Option<BidId>;
    'Vec<BidId>': Vec<BidId>;
  }
}
