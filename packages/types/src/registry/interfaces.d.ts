...
import type { DepositData, PoolId, PoolInfo, PoolState, PoolType, RewardData } from '@bifrost-finance/types/interfaces/liquidityMining';
import type { IsExtended, SystemPalletId } from '@bifrost-finance/types/interfaces/minterReward';
import type { Amount, AmountOf, Currency, CurrencyId, CurrencyIdOf, MinimumsMaximums, ShareWeight, StorageVersion, TimeUnit, TokenSymbol, TransferOriginType } from '@bifrost-finance/types/interfaces/primitives';
...
import type { CompactBalance, OrmlCurrencyId, PoolInfoV0, Share } from '@open-web3/orml-types/interfaces/rewards';
import type { OrmlBalanceLock } from '@open-web3/orml-types/interfaces/tokens';
