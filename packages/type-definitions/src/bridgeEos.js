...
exports.default = {
    ...
    types: {
        ...
        bridgeEosSignature: { type_: 'UnsignedInt', data: '[u8;65]' },
        BlockTimestamp: '(u32)',
        ...
        SignedBlockHeader: { block_header: 'BlockHeader', producer_signature: 'bridgeEosSignature' },
        ...
        BlockSigningAuthorityV0: { threshold: 'u32', keyWeights: 'Vec<KeyWeight>' },
